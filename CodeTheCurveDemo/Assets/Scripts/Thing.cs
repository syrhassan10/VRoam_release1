...
public class Thing : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        uiDISTANCE.text = "Distance Walked: "+distanceWalked.ToString();
        uiSPEED.text = "Speed: " + playerSpeed.ToString();
        uiMET.text = "MET: " + MET.ToString();
        uiCALORIES.text = "Calories Burned: " + caloriesBurned.ToString();
